...
// Use the base URL without /api suffix since it's already included in the environment variable
const API_URL = import.meta.env.VITE_API_URL?.replace('/api', '') || 'https://final-2-1yn4.onrender.com';
